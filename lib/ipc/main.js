...
/**
 * The main process should use this interface to communicate with the renderer process.
 * 
 ...
 * IPC logic so that if newer conventions arise, a simple update to this module would
 * suffice.
**/

// Static class for sending and registering receivers for IPC messages to/from renderer processes
class MainIpc {
